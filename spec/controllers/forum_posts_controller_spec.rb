...
RSpec.describe ForumPostsController, type: :controller do
  ...
  describe '#create' do
    ...
    context 'with valid data' do
      it 'returns the post' do
        ...
        expect(subject['message']).to eq('Test post message 1')
      end
    end
  end
  ...
  describe '#index' do
    ...
    context 'with 2 posts' do
      ...
      it 'returns 2 posts' do
        get :index
        expect(subject.first['message']).to eq('Test post message 1')
        expect(subject.second['message']).to eq('Test post message 2')
      end
    end
  end
  ...
  describe '#show' do
    ...
    context 'with 2 posts' do
      ...
      it 'returns 1 post' do
        ...
        expect(subject['message']).to eq('Test post message 2')
      end
    end
  end
  ...
  describe '#update' do
    ...
    context ' with valid data' do
      it 'returns the forum post' do
        ...
        expect(subject['message']).to eq('New forum post message')
      end
    end
  end
  ...
  describe '#destroy' do
    ...
    context 'with 2 posts' do
      ...
      it 'destroys 1 post' do
        delete :destroy, params: { id: forum_post_2.id }
